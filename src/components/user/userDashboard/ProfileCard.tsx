...
const ProfileCard: FC<ProfileCardProps> = ({ name, customerId, email, status }) => {
  return (
      ...
      <div className="pt-20 pb-8 px-8 text-center">
        ...
        <div className="mt-4 space-y-2">
          <p className="text-gray-600">
            Customer ID: <span className="font-semibold text-teal-600">{customerId}</span>
          </p>
        ...
        <div className="flex flex-col items-center gap-4 mt-6">
          <button className="w-full bg-yellow-400 hover:bg-yellow-500 text-gray-800 font-semibold py-3 px-8 rounded-lg transition">
            Complete the Profile and All Documents
          </button>
